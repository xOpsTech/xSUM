...
exports.SUBSCRIPTION_LIST = 'subscriptionList';
...
exports.POINT_NOT_ENOUGH_ERROR =
    "You can't add anymore jobs. Please contact administrator for any help...";
exports.POINT_NOT_ENOUGH_UPDATE_ERROR =
    "You don't have points to update this job. Please contact administrator for any help...";
exports.USER_LIMIT_REACHED =
    'You have reached to the user limit for this account. Please contact administrator for any help...';
...
exports.ACCESS_LIST = [
    {
        role: this.SUPER_USER,
        resource: this.ANY_RESOURCE,
        action: 'create:any',
        attributes: '*'
    },
    {
