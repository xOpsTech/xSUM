...
/*        context.sendEmailAs (
        ...
        if(user&&jobList){           
          ...
          MongoDB.updateUserList(AppConstants.DB_NAME ,AppConstants.USER_LIST  , user);
        }
        else{
             MongoDB.updateUserListfor(AppConstants.DB_NAME ,AppConstants.USER_LIST , user);
        } 
